...
public class Product implements Serializable {
	...
	//it's Set and not List because with Set we let JPA know that we won't allow the same item be repeated
	@ManyToMany
	...
	@OneToMany(mappedBy = "id.product")//id comes from OrderItemOK id
